<?php
/*Ajustando a formatacao da data e hora na tela
        ...
        <div class="glass-box mx-auto p-4 p-md-5" style="max-width: 900px;">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4 pb-3 border-bottom">
                ...
                <button onclick="window.print()"
                    class="btn btn-light border text-secondary btn-sm no-print rounded-pill px-3 fw-bold">
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    <div class="info-card h-100" style="border-left-color: #6c757d;">
                        ...
                        <span class="fw-bold fs-6 text-dark"><i class="bi bi-person me-1"></i>
                            <?= htmlspecialchars($requisicao['solicitante']) ?></span>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="info-card h-100" style="border-left-color: #0dcaf0;">
                        ...
                        <span class="fw-bold fs-6 text-dark"><i class="bi bi-calendar-event me-1"></i>
                            <?= date('d/m/y \à\s H:i', strtotime($requisicao['data_pedido'])) ?></span>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <?php
                    $bl_c = '#ffc107';
                    $s_t = 'Aguardando Análise';
                    if ($requisicao['status'] === 'Atendido') {
                        $bl_c = '#198754';
                        $s_t = 'Finalizado';
                    } elseif ($requisicao['status'] === 'Negado') {
                        $bl_c = '#dc3545';
                        $s_t = 'Cancelado';
                    }
                    ?>
                    <div class="info-card h-100" style="border-left-color: <?= $bl_c ?>;">
                        ...
                        <span class="fw-bold fs-6 text-dark"><?= $requisicao['status'] ?> <small
                                class="fw-normal text-muted">(<?= $s_t ?>)</small></span>
                    </div>
                </div>
            </div>
                ...
                <div class="alert alert-danger px-4 py-3 rounded-4 border-0 shadow-sm mt-2 mb-4">
                    <div class="d-flex">
                        ...
                        <div>
                            ...
                            <p class="mb-0 text-dark small"><b>Motivo informado pelo setor:</b>
                                "<?= nl2br(htmlspecialchars($requisicao['justificativa'])) ?>"</p>
                        </div>
                    </div>
                </div>
            <?php endif; ?>
                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light text-secondary small text-uppercase">
                        <tr>
                            ...
                            <th width="110" class="text-center fw-bold border-0 bg-primary bg-opacity-10 text-primary">
                                Pedido</th>
                            <th width="110" class="text-center fw-bold border-0 bg-success bg-opacity-10 text-success">
                                Entregue</th>
                            ...
                            <tr>
                                ...
                                <td class="ps-4">
                                    ...
                                    <div class="small text-muted text-truncate" style="max-width: 250px;">
                                        <?= htmlspecialchars($item['descricao']) ?></div>
                                </td>
                                ...
                                <td class="text-center bg-primary bg-opacity-10 fw-bold text-primary fs-5">
                                    <?= $item['qtd_pedida'] ?></td>
